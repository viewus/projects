 ...
 */
var BLOG_POST_DATA = {
  title: "New Build vs. Period Property: The 2026 Verdict",
  description: "Modern efficiency or timeless character? We weigh up the pros and cons of UK housing types in today's market.",
  stats: [{ label: "Efficiency", num: "A/B" }, { label: "Character", num: "High" }, { label: "Resale", num: "Stable" }],
  sections: [{
    tag: "Comparison",
