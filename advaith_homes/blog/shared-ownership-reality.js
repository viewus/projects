 ...
 */
var BLOG_POST_DATA = {
  title: "Shared Ownership: Is It a Trap or a Ticket?",
  description: "Buying a percentage of your home can be a great entry point, but the 'staircasing' costs can be high. We break down the reality of 2026 schemes.",
  stats: [{ label: "Entry", num: "25%" }, { label: "Rent", num: "Low" }, { label: "Complexity", num: "High" }],
  sections: [{
    tag: "Options",
