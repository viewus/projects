 ...
 */
var BLOG_POST_DATA = {
  title: "Mortgage Secrets: How to Unlock 2026's Best Rates",
  description: "Banks don't always advertise their best deals. Learn how 'broker-only' products and offset mortgages can save you thousands in interest.",
  stats: [{ label: "Avg Rate", num: "4.5%" }, { label: "Broker Save", num: "0.5%" }, { label: "Options", num: "100+" }],
  sections: [{
    tag: "Finance",
